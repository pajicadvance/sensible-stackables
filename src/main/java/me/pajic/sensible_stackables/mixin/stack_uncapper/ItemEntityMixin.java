...
public class ItemEntityMixin {
    ...
    private static int uncapMergeSize(int original, @Local(ordinal = 1, argsOnly = true) ItemStack originStack) {
        return ModConfig.CONFIG.uncapStackSize() ? originStack.getMaxStackSize() : original;
    }
}
